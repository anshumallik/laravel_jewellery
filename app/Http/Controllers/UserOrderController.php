...
class UserOrderController extends Controller
{
    ...
    public function showOrder($id)
    {
        ...
        return view('admin.userorder.show', compact('product', 'category', 'user_order', 'order_item', $order_item));
    }
    ...
    public function edit($id)
    {
        ...
        $user_order = UserOrder::where('id', $id)->with('order_items')->first();
        return view('admin.userorder.edit', compact('user_order', 'categories', 'products'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('user_orders.index', compact('user_order'))
            ->with($notification);
